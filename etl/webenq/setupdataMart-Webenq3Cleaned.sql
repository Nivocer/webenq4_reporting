...
CREATE TABLE IF NOT EXISTS stage_lookup_respondent (
...
CREATE TABLE IF NOT EXISTS stage_lookup_question (
...
CREATE TABLE IF NOT EXISTS stage_lookup_answer_label (
                question_id INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS lookup_answer_label (
...
CREATE TABLE IF NOT EXISTS dim_training (
...
CREATE TABLE IF NOT EXISTS fact_answer (
                respondent_key INT NOT NULL,
                question_key INT NOT NULL,
                answer_label_key INT NOT NULL,
                date_key INT NOT NULL,
